...
VALUES  ('GREATWORKOBJECT_HONEY_MACGUFFIN_PASSIVE',	 8, 'PSEUDOYIELD_GPP_GREAT_PERSON_HONEY_MACGUFFIN_GP', 'LOC_GREATWORKOBJECT_HONEY_MACGUFFIN_PASSIVE_NAME',  '[ICON_Honey_Passive_Macguffin]'), --TO DO change iconstring
		('GREATWORKOBJECT_HONEY_MACGUFFIN_ACTIVE',   9, 'PSEUDOYIELD_GPP_GREAT_PERSON_HONEY_MACGUFFIN_GP', 'LOC_GREATWORKOBJECT_HONEY_MACGUFFIN_ACTIVE_NAME',    '[ICON_Honey_Active_Macguffin]'); --TO DO change iconstring
