...
VALUES ('TEST_BOOST_WRITING_MODIFIER', 'MODIFIER_PLAYER_CITIES_ADJUST_EXTRA_GREAT_WORK_SLOTS');

INSERT INTO ModifierArguments
		(ModifierId, Name, Value)
VALUES  ('TEST_BOOST_WRITING_MODIFIER', 'BuildingType', 'BUILDING_HONEY_MACGUFFIN_HOLDER_EMPTY'),
		('TEST_BOOST_WRITING_MODIFIER', 'GreatWorkSlotType', 'GREATWORKSLOT_HONEY_MACGUFFIN'),
		('TEST_BOOST_WRITING_MODIFIER', 'Amount', 1);

INSERT INTO BuildingModifiers
		(BuildingType,											 ModifierId)
VALUES  ('BUILDING_PALACE',  'TEST_BOOST_WRITING_MODIFIER');
