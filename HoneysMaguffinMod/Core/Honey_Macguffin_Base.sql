...
VALUES  ('GREATWORKOBJECT_HONEY_MACGUFFIN_PASSIVE',		 10, 'PSEUDOYIELD_GPP_GREAT_PERSON_HONEY_MACGUFFIN_GP', 'LOC_GREATWORKOBJECT_HONEY_MACGUFFIN_PASSIVE_NAME',  '[ICON_GreatWork_Relic]'), --TO DO change iconstring
		('GREATWORKOBJECT_HONEY_MACGUFFIN_ACTIVE',		11, 'PSEUDOYIELD_GPP_GREAT_PERSON_HONEY_MACGUFFIN_GP', 'LOC_GREATWORKOBJECT_HONEY_MACGUFFIN_ACTIVE_NAME',    '[ICON_GreatWork_Relic]'); --TO DO change iconstring
...
VALUES	('BUILDING_HONEY_MACGUFFIN_HOLDER_EMPTY',  'GREATWORKSLOT_HONEY_MACGUFFIN',      1 ),
		('BUILDING_PALACE',  'GREATWORKSLOT_HONEY_MACGUFFIN',      1 );
