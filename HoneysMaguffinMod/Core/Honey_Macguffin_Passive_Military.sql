...
VALUES  (  'ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF',  'LOC_ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_NAME', 'LOC_ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_DESC' ),
		(  'ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER2',  'LOC_ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER2_NAME', 'LOC_ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER2_DESC' ),
		(  'ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER3',  'LOC_ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER3_NAME', 'LOC_ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER3_DESC' );
...
VALUES  ('MODIFIER_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_ABILITY_GRANTER',  'AbilityType', 'ABILITY_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF'),
		('MODIFIER_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER2',                   'Amount',           3                                     ),
		...
		('MODIFIER_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER2',                   'Amount',           5                                     ),
		...
		('MODIFIER_HONEY_MACGUFFIN_PASSIVE_MELEE_BUFF_TIER3',                   'Amount',           8                                     );
