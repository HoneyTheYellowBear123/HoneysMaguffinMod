...
<AssetObjects..TextureInstance>
	...
	<m_ExportedTime>538967154</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LaunchBar_HoneyMacguffinActiveCooldown.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LaunchBar_HoneyMacguffinActiveCooldown"/>
	<m_Description text=""/>
	<m_Tags>
