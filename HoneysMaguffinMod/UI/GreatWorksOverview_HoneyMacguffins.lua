...
function GetGreatWorkTooltip(pCityBldgs:table, greatWorkIndex:number, greatWorkType:number, pBuildingInfo:table)
	...
	print("HoneyDebugOverview get great work tool tip was called");
	...
	if kGreatWorkInfo.GreatWorkObjectType == "GREATWORKOBJECT_HONEY_MACGUFFIN_PASSIVE" then
		print("HoneyDebugOverview danger point 1");
...
function GetGreatWorkIcon(greatWorkInfo:table)
	...
	print("HoneyDebugOverview Get Great Work Icon was called");
	...
	if greatWorkInfo.GreatWorkObjectType == "GREATWORKOBJECT_HONEY_MACGUFFIN_PASSIVE" then
		...
		print("HoneyDebugOverview great work icon "..greatWorkIcon);
		...
		if(textureSheet == nil or textureSheet == "") then
			print("HoneyDebugOverview danger point 2");
...
function GetGreatWorkSlotTypeIcon(slotType:string)
	...
	--print("HoneyDebugOverview honeydebug2 get great works slot type icon was called");

	for v1, v2 in pairs(g_DEFAULT_GREAT_WORKS_ICONS) do
		print("HoneyDebugOverview showingtable"..tostring(v1).."   "..tostring(v2));
	end

	--print("HoneyDebugOverview honeydebug2 made it past the table which will return "..g_DEFAULT_GREAT_WORKS_ICONS[slotType].." because of "..slotType);
	print("HoneyDebugOverview Slot type for getgreatworkslottypeicon: "..slotType)
	print("HoneyDebugOverview what we will return for getgreatworkslottypeicon: "..g_DEFAULT_GREAT_WORKS_ICONS[slotType])
...
function PopulateGreatWorkSlot(instance:table, pCity:table, pCityBldgs:table, pBuildingInfo:table)
	...
	print("HoneyDebugOverview PopulateGreatWorkSlot was called");
	--if (not (pBuildingInfo.BuildyingType == 'BUILDING_HONEY_MACGUFFIN_HOLDER_EMPTY')) then
	--	BASE_PopulateGreatWorkSlot(instance,pCity,pCityBlgs,pBuildingInfo)
	--end
	print("HoneyDebugOverview PopulateGreatWorkSlot thinks this building is a macguffin holder!");
	...
	if (numSlots ~= nil and numSlots > 0) then
		...
		print("HoneyDebugOverview HoneyDebug a");
		if firstGreatWork ~= nil and themeDescription ~= nil then
			print("HoneyDebugOverview HoneyDebug b");
			local slotTypeIcon:string = "ICON_" .. firstGreatWork.GreatWorkObjectType;
			print("HoneyDebugOverview HoneyDebug "..slotTypeIcon);
	...
	print("HoneyDebugOverview HoneyDebug c");
	return numGreatWorks;
end
--]]

print("HoneyDebugOverview UI overview script was loaded");
